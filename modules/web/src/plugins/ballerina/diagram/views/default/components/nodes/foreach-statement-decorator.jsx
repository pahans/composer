 ...
 */
class ForeachStatementDecorator extends React.Component {
...
ForeachStatementDecorator.defaultProps = {
    draggable: null,
    children: null,
    undeletable: false,
    editorOptions: null,
...
ForeachStatementDecorator.propTypes = {
...
ForeachStatementDecorator.contextTypes = {
...
export default breakpointHoc(ForeachStatementDecorator);
